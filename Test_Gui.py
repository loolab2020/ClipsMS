...
Disclaimer = Label(bottomframe, text = 'If data is analyzed with this program, please cite xxxxxxxx paper')
...
UCLA = PhotoImage(file = 'UCLA.png')
UCLA_photo = Label(root, image = UCLA)
