        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="A Fragments"):
            for i in range(0, a):
                ...
                if abs((instfrags[g] - arra[m] - mod - N_Term_Mod) / (arra[m] + mod + N_Term_Mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    csvData = [[frag_number, 'A Fragment', str(mod - v_mod), str(v_mod), str(N_Term_Mod), str(instfrags[g]), str(arra[m]), str(1), str(arrlenlistaf[m]), str(round(Error, 5)), str(arraf[m]), str(intensities[g]), str(0)]]
                    holdv = m
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="B Fragments"):
            for i in range(0, b):
                ...
                if abs((instfrags[g] - arrb[m] - mod - N_Term_Mod) / (arrb[m] + mod + N_Term_Mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arrbf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'B Fragment', str(mod - v_mod), str(v_mod), str(N_Term_Mod), str(instfrags[g]), str(arrb[m]), str(1), str(arrlenlistbf[m]), str(round(Error, 5)), str(arrbf[m]), str(intensities[g]), str(0)]]
                    holdv = m
                    for i in range(holdv, -1, -1):
                        list_of_counts_arr_terminal[holdv] = list_of_counts_arr_terminal[holdv] + 1
                        holdv = holdv - 1
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="C Fragments"):
            for i in range(0, c):
                ...
                if abs((instfrags[g] - arrc[m] - mod - N_Term_Mod) / (arrc[m] + mod + N_Term_Mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arrcf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'C Fragment', str(mod - v_mod), str(v_mod), str(N_Term_Mod), str(instfrags[g]), str(arrc[m]), str(1), str(arrlenlistcf[m]), str(round(Error, 5)), str(arrcf[m]), str(intensities[g]), str(0)]]
                    holdv = m
                    for i in range(holdv, -1, -1):
                        list_of_counts_arr_terminal[holdv] = list_of_counts_arr_terminal[holdv] + 1
                        holdv = holdv - 1
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="X Fragments"):
            for i in range(0, x):
                ...
                if abs((instfrags[g] - arrx[m] - mod - C_Term_Mod) / (arrx[m] + mod + C_Term_Mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arrxf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'X Fragment', str(mod - v_mod), str(v_mod), str(C_Term_Mod), str(instfrags[g]), str(arrx[m]), str(arrlenlistxf[m]), str(length_sequence), str(round(Error, 5)), str(arrxf[m]), str(intensities[g]), arrlenlistxf[m] - 1]]
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="Y Fragments"):
            for i in range(0, y):
                ...
                if abs((instfrags[g] - arry[m] - mod - C_Term_Mod) / (arry[m] + mod + C_Term_Mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arryf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'Y Fragment', str(mod - v_mod), str(v_mod), str(C_Term_Mod), str(instfrags[g]), str(arry[m]), str(arrlenlistyf[m]), str(length_sequence), str(round(Error, 5)), str(arryf[m]), str(intensities[g]), arrlenlistyf[m] - 1]]
                    holdv = length_sequence - m - 1
                    for i in range(holdv, length_sequence, 1):
                        list_of_counts_arr_terminal[holdv] = list_of_counts_arr_terminal[holdv] + 1
                        holdv = holdv + 1
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="Z Fragments"):
            for i in range(0, z):
                ...
                if abs((instfrags[g] - arrz[m] - mod - C_Term_Mod) / (arrz[m] + mod + C_Term_Mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arrzf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'Z Fragment', str(mod - v_mod), str(v_mod), str(C_Term_Mod), str(instfrags[g]), str(arrz[m]), str(arrlenlistzf[m]), str(length_sequence), str(round(Error, 5)), str(arrzf[m]), str(intensities[g]), arrlenlistzf[m] - 1]]
                    holdv = length_sequence - m - 1
                    for i in range(holdv, length_sequence, 1):
                        list_of_counts_arr_terminal[holdv] = list_of_counts_arr_terminal[holdv] + 1
                        holdv = holdv + 1
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="AX Fragments"):
            for i in range(0, intfraglength):
                ...
                if abs((instfrags[g] - arrax[m] - mod) / (arrax[m] + mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arrintf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'AX Int Fragment', str(mod - v_mod), str(v_mod), str(0), str(instfrags[g]), str(arrax[m]), str(arrlenlistfl[m]), str(arrlenlistbl[m]), str(round(Error, 5)), str(arrintf[m]), str(intensities[g]), arrlenlistfl[m] - 1]]
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="AY Fragments"):
            for i in range(0, intfraglength):
                ...
                if abs((instfrags[g] - arrays[m] - mod) / (arrays[m] + mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arrintf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'AY Int Fragment', str(mod - v_mod), str(v_mod), str(0), str(instfrags[g]), str(arrays[m]), str(arrlenlistfl[m]), str(arrlenlistbl[m]), str(round(Error, 5)), str(arrintf[m]), str(intensities[g]), arrlenlistfl[m] - 1]]
                    holdv = arrlenlistfl[m] - 1
                    holdvn = arrlenlistbl[m]
                    for i in range(holdv, holdvn):
                        list_of_counts_arr_internal[holdv] = list_of_counts_arr_internal[holdv] + 1
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="AZ Fragments"):
            for i in range(0, intfraglength):
                ...
                if abs((instfrags[g] - arraz[m] - mod) / (arraz[m] + mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arrintf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'AZ Int Fragment', str(mod - v_mod), str(v_mod), str(0), str(instfrags[g]), str(arraz[m]), str(arrlenlistfl[m]), str(arrlenlistbl[m]), str(round(Error, 5)), str(arrintf[m]), str(intensities[g]), arrlenlistfl[m] - 1]]
                    holdv = arrlenlistfl[m] - 1
                    holdvn = arrlenlistbl[m]
                    for i in range(holdv, holdvn):
                        list_of_counts_arr_internal[holdv] = list_of_counts_arr_internal[holdv] + 1
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="BX Fragments"):
            for i in range(0, intfraglength):
                ...
                if abs((instfrags[g] - arrbx[m] - mod) / (arrbx[m] + mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arrintf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'BX Int Fragment', str(mod - v_mod), str(v_mod), str(0), str(instfrags[g]), str(arrbx[m]), str(arrlenlistfl[m]), str(arrlenlistbl[m]), str(round(Error, 5)), str(arrintf[m]), str(intensities[g]), arrlenlistfl[m] - 1]]
                    holdv = arrlenlistfl[m] - 1
                    holdvn = arrlenlistbl[m]
                    for i in range(holdv, holdvn):
                        list_of_counts_arr_internal[holdv] = list_of_counts_arr_internal[holdv] + 1
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="BY Fragments"):
            for i in range(0, intfraglength):
                ...
                if abs((instfrags[g] - arrby[m] - mod) / (arrby[m] + mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arrintf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'BY Int Fragment', str(mod - v_mod), str(v_mod), str(0), str(instfrags[g]), str(arrby[m]), str(arrlenlistfl[m]), str(arrlenlistbl[m]), str(round(Error, 5)), str(arrintf[m]), str(intensities[g]), arrlenlistfl[m] - 1]]
                    holdv = arrlenlistfl[m] - 1
                    holdvn = arrlenlistbl[m]
                    for i in range(holdv, holdvn):
                        list_of_counts_arr_internal[holdv] = list_of_counts_arr_internal[holdv] + 1
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="BZ Fragments"):
            for i in range(0, intfraglength):
                ...
                if abs((instfrags[g] - arrbz[m] - mod) / (arrbz[m] + mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arrintf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'BZ Int Fragment', str(mod - v_mod), str(v_mod), str(0), str(instfrags[g]), str(arrbz[m]), str(arrlenlistfl[m]), str(arrlenlistbl[m]), str(round(Error, 5)), str(arrintf[m]), str(intensities[g]), arrlenlistfl[m] - 1]]
                    holdv = arrlenlistfl[m] - 1
                    holdvn = arrlenlistbl[m]
                    for i in range(holdv, holdvn):
                        list_of_counts_arr_internal[holdv] = list_of_counts_arr_internal[holdv] + 1
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="CX Fragments"):
            for i in range(0, intfraglength):
                ...
                if abs((instfrags[g] - arrcx[m] - mod) / (arrcx[m] + mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arrintf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'CX Int Fragment', str(mod - v_mod), str(v_mod), str(0), str(instfrags[g]), str(arrcx[m]), str(arrlenlistfl[m]), str(arrlenlistbl[m]), str(round(Error, 5)), str(arrintf[m]), str(intensities[g]), arrlenlistfl[m] - 1]]
                    holdv = arrlenlistfl[m] - 1
                    holdvn = arrlenlistbl[m]
                    for i in range(holdv, holdvn):
                        list_of_counts_arr_internal[holdv] = list_of_counts_arr_internal[holdv] + 1
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="CY Fragments"):
            for i in range(0, intfraglength):
                ...
                if abs((instfrags[g] - arrcy[m] - mod) / (arrcy[m] + mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arrintf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'CY Int Fragment', str(mod - v_mod), str(v_mod), str(0), str(instfrags[g]), str(arrcy[m]), str(arrlenlistfl[m]), str(arrlenlistbl[m]), str(round(Error, 5)), str(arrintf[m]), str(intensities[g]), arrlenlistfl[m] - 1]]
                    holdv = arrlenlistfl[m] - 1
                    holdvn = arrlenlistbl[m]
                    for i in range(holdv, holdvn):
                        list_of_counts_arr_internal[holdv] = list_of_counts_arr_internal[holdv] + 1
        ...
        for i in tqdm(range(0, ifl), total=ifl, desc="CZ Fragments"):
            for i in range(0, intfraglength):
                ...
                if abs((instfrags[g] - arrcz[m] - mod) / (arrcz[m] + mod) * 1000000) < PPM_Error_tolerance:
                    ...
                    # print(arrintf[m])
                    frag_number = frag_number + 1
                    csvData = [[frag_number, 'CZ Int Fragment', str(mod - v_mod), str(v_mod), str(0), str(instfrags[g]), str(arrcz[m]), str(arrlenlistfl[m]), str(arrlenlistbl[m]), str(round(Error, 5)), str(arrintf[m]), str(intensities[g]), arrlenlistfl[m] - 1]]
                    holdv = arrlenlistfl[m] - 1
                    holdvn = arrlenlistbl[m]
                    for i in range(holdv, holdvn):
                        list_of_counts_arr_internal[holdv] = list_of_counts_arr_internal[holdv] + 1
...
if row_count_frags == 2:
    messagebox.showinfo("ClipsMS Error", "No Fragments Were Found")
