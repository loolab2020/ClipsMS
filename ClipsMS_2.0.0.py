        ...
        if valueAX == 1 \
            ...
            if answer == 'yes':
                ...
                csvData = [['Frag_number', 'Frag Type', 'Localized Mod', 'Unlocalized Mod', 'Term Mod', 'Observed Mass',
                            'Theoredical Mass', 'Start AA', 'End AA', 'Error', 'Sequence', 'Intensity',
                ...
                print("Assinged Peak Percentage (APP): " + str(round(APP, 2)) + '%')

                with open('Statistics.csv', 'w') as csvFile:
                    csvFile.close()
                statistics_list = ['Number of N-Termianl Fragments', 'Number of C-Terminal Fragments',
                ...
                keep_col = ['Frag_number', 'Frag Type', 'Localized Mod', 'Unlocalized Mod', 'Term Mod', 'Observed Mass',
                            'Theoredical Mass', 'Start AA', 'End AA', 'Error', 'Sequence', 'Intensity', 'Formula']
                new_f = f[keep_col]
